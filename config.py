...
BOT_USERNAME = getenv("BOT_USERNAME" , "testinh121bot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "AarohiV2")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "Hania_X_Dil")
EVALOP = list(map(int, getenv("EVALOP", "6321307663 5360305806 6691393517").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002106283057))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/dilop121/V2-test",
)
